...
if [ -f "/.do_deploy_jasperserver" ]; then
    ...
    # add phantomjs
    echo "net.sf.jasperreports.phantomjs.executable.path=/usr/local/bin/phantomjs" >> /usr/local/tomcat/webapps/ROOT/WEB-INF/classes/jasperreports.properties
    echo "com.jaspersoft.jasperreports.components.customvisualization.phantomjs.executable.path=/usr/local/bin/phantomjs" >> /usr/local/tomcat/webapps/ROOT/WEB-INF/classes/jasperreports.properties
